...
把不同域名的玩家通过 **[Tailscale](https://tailscale.com/) 加密隧道**转发到不同的内网游戏机上。
...
> 仅适用于 **Minecraft Java 版**（或其他TCP，握手带域名）。UDP服务不适用。
>
> 202606更新 - 服务器到期时间2027年底。届时请部署 [完整docker方案](https://github.com/Kylaan/docker-mcrouter) 到新服务器即可
